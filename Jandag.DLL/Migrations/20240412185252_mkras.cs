...
{
    /// <inheritdoc />
    public partial class mkras : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Reciever_port = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Source_emr = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Emr60infos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sources_Chanells_ChanellId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Desclamlers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Desclamlers_Sources_Source_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transcoders_Sources_Source_Id",
                        column: x => x.Source_Id,
                        principalTable: "Sources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "DesclamlerCards",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Card_Manufacturer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Card_Code = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DesclamblerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DesclamlerCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DesclamlerCards_Desclamlers_DesclamblerId",
                        column: x => x.DesclamblerId,
                        principalTable: "Desclamlers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DesclamlerCards_DesclamblerId",
                table: "DesclamlerCards",
                column: "DesclamblerId");

            migrationBuilder.CreateIndex(
                name: "IX_Desclamlers_Source_Id",
                table: "Desclamlers",
                column: "Source_Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Sources_ChanellId",
                table: "Sources",
                column: "ChanellId");
